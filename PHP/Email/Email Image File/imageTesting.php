...
/*$image_name=time().$image['filename'].'.'.$extension;*/  /*ORIGNAL*/

$image_name=addslashes($_FILES['image']['name']); /* EDITED : THIS WILL LEAVE THE SAME IMAGE NAME AS BEING UPLOADED BY THE CLIENT*/
