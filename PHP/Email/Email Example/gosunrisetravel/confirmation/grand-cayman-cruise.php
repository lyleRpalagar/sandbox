...
<html>
	...
	<head>
		...
		<title>Grand Cayman | Sunrise Travel</title>
		...
		<?php include '../confirmation/include/headConfirmation.php'; ?>
				...
				<style>
					.image{
						background-image: url('/confirmation/images/grand-cayman.jpg');
					}
				</style>
				<!-- /STYLING FOR BACKGROUND IMAGE -->
						...
						<div class="transparentBackground">
							<table>
							 ...
							 <th>
							 	<tr>
							 		<td> 
							 			<h1>Grand Cayman Cruise</h1>
							 				<p>You're only minutes away from the perfect vacation. Well known for its spectacular water, beautiful resorts, and hundreds of popular activities.</p>
							 		</td>
							 	</tr>
...
<!-- _____________________| TO MAKE ANOTHER PAGE CHANGE THE VALUE="TEMPLATE" INTO THE NAME YOUR [NAME]CONFIRMATION.PHP IS  |________________________-->
									 	 ...
									 	 <input type="hidden" id="packages" value="grand-cayman-cruise">
