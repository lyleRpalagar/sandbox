							...
							<table>
							 ...
							 <th>
							 	<tr>
							 		<td> 
							 			<h1>Alaska Cruise</h1>
							 				<p>You're only minutes away from the perfect vacation. Full of adventure and exciting outdoor activities, Alaska is one of the most beautiful places on earth.</p>
							 		</td>
							 	</tr>
...
<!-- _____________________| TO MAKE ANOTHER PAGE CHANGE THE VALUE="TEMPLATE" INTO THE NAME YOUR [NAME]CONFIRMATION.PHP IS  |________________________-->
									 	 ...
									 	 <input type="hidden" id="packages" value="alaska-cruise">
