						...
						<div class="transparentBackground">
							<table>
							 ...
							 <th>
							 	<tr>
							 		<td> 
							 			<h1>Barbados Cruise</h1>
							 				<p>You're only minutes away from the perfect vacation. Warm tropical islands, white sandy beaches, blue-green water over beautiful coral reefs, and so much more.</p>
							 		</td>
							 	</tr>
...
<!-- _____________________| TO MAKE ANOTHER PAGE CHANGE THE VALUE="TEMPLATE" INTO THE NAME YOUR CONFIRMATION.PHP IS  |________________________-->
									 	 ...
									 	 <input type="hidden" id="packages" value="barbados-cruise">
