...
<html>
	...
	<head>
		...
		<title>Form | Sunrise Travel</title>
		...
		<?php include '../confirmation/include/headConfirmation.php'; ?>
				...
				<style>
					.image{
						background-image: url('/confirmation/images/bg2.png');
					}
				</style>
				<!-- /STYLING FOR BACKGROUND IMAGE -->
						...
						<div class="transparentBackground">
							<table>
							 ...
							 <th>
							 	<tr>
							 		<td> 
							 			<h1>Welcome To the Grand</h1>
							 				<p class="confirmationFormContent"> Now that there is the Tec-9, a Crappy spray gun from South Miami. This gun is advertised
							 					as the most popular gun in America. </p>
							 		</td>
							 	</tr>
				...
				<!-- <td valign="top"> <label for="[name]">[ insert if you want to put the names on the side of the form ] </label> </td> --> <!-- /td -->
								...
								<tr>
									...
									<!-- <td valign="top"> <label for="[name]">[ insert if you want to put the names on the side of the form ] </label> </td> --> <!-- /td -->
									 ...
									 <input  type="text" id="arrive" name="arrive" class="date" maxlength="11" size="20" placeholder="Check-in" style="line-height:2em;">

									 <input  type="text" id="depart" name="depart" class="date" maxlength="12" size="23" placeholder="Check-out" style="line-height:2em;">
									  </td> <!-- /td -->
	 ...
	 -->
				 		 ...
				 		 <!-- _________Policy _________ -->
								<tr>
								 <td>
								 	<div id="policyDiv">
								 		<p class="confirmationPolicyContent">This is the privacy Policy<br/>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
								 		 Phasellus tempor lobortis erat. <a href="#">Privacy Policy</a></p> 
								 	</div>
								 </td>
								</tr>
...
<!-- _____________________| TO MAKE ANOTHER PAGE CHANGE THE VALUE="TEMPLATE" INTO THE NAME YOUR CONFIRMATION.PHP IS  |________________________-->

									 	 <input type="hidden" id="packages" value="barbados">
