<?php
 ...
 <h1> You Are Modifying A Property Page </h1>
	<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
		...
		<b> Col1: <br/><textarea  rows ="10" cols="50" type="text" name="col1"><?php echo $website_id['col1']; ?></textarea><br/> </b>
		<b> Col2: <br/><textarea  rows ="10" cols="50" type="text" name="col2"><?php echo $website_id['col2']; ?></textarea><br/> </b>
		<b> Col3: <br/><textarea  rows ="10" cols="50" type="text" name="col3"><?php echo $website_id['col3']; ?></textarea><br/> </b>
		<b> Col4: <br/><textarea  rows ="10" cols="50" type="text" name="col4"><?php echo $website_id['col4']; ?></textarea><br/> </b>
